...
# pipenv install confluent-kafka[avro]
...
class ClickEvent:
    ...
    #
    # Loads the schema using the Confluent avro loader
...
async def produce(topic_name):
    ...
    #
    # CachedSchemaRegistryClient is a client talk to SCHEMA_REGISTRY
...
async def consume(topic_name):
    ...
    #
    c = AvroConsumer(
        {"bootstrap.servers": BROKER_URL, "group.id": "0"}, schema_registry=schema_registry
    )
